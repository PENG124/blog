<?php
/* Smarty version 3.1.30, created on 2017-10-25 02:26:11
  from "D:\wamp\www\mvc\template\admin\login.html" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.30',
  'unifunc' => 'content_59eff643c417d1_06540452',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'c67373722f41111babed3eed2b2a4b4e6ba51400' => 
    array (
      0 => 'D:\\wamp\\www\\mvc\\template\\admin\\login.html',
      1 => 1508898370,
      2 => 'file',
    ),
  ),
...
function content_59eff643c417d1_06540452 (Smarty_Internal_Template $_smarty_tpl) {
?>
<!doctype html>
<html lang="en">
<head>
...
<body>
        <div class="big">
            ...
            <div class="loginreg">
                <div class="login">
                    <form class="form-horizontal" action="index.php?m=admin&f=admin&a=loginCon" method="post">
                        <!---->
                        ...
                        <div class="form-group">
                            ...
                            <img src="index.php?m=admin&f=admin&a=codeimg" class="codeimg" alt="" onclick="src='index.php?m=admin&f=admin&a=codeimg'">
                        </div>
                        <div class="form-group">
                ...
                <div class="reg">
                    <form class="form-horizontal" action="index.php?m=admin&f=admin&a=regCon" method="post">
                        <div class="form-group">
